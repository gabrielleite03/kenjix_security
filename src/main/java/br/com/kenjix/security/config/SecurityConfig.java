package br.com.kenjix.security.config;

import br.com.kenjix.security.filters.JwtTokenFilter;
import br.com.kenjix.security.service.JwtTokenProviderService;
...
public class SecurityConfig {
    ...
    @Autowired
    public SecurityConfig(JwtTokenProviderService tokenProviderService) {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        JwtTokenFilter filter = new JwtTokenFilter(tokenProviderService);
